...
| 0 | git init + .gitignore | Pending |
| 0 | Scaffold Next.js 16 + React 19 + TS + Tailwind v4 | Pending |
| 1 | Design token + theme system | Pending |
| 2 | Headless game engine + tests | Pending |
